...
To keep things simple I started with a simple implementation that can process numbers and on top of that another one which reads out the time. So the starting point are some classes that tranlate numbers to test.
...
\end{DoxyCode}
 The result is\+: NOON\hypertarget{index_autotoc_md4}{}\doxysection{Text to Speech}\label{index_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md5}{}\doxysection{Memory Usage}\label{index_autotoc_md5}
...
I think this leave plenty of headroom and you still have the option to store the audio on an SD drive...\hypertarget{index_autotoc_md6}{}\doxysection{Documentation}\label{index_autotoc_md6}
Here is the \href{https://pschatzmann.github.io/arduino-simple-tts/docs/html/annotated.html}{\texttt{ link to the generated class documentation}}. Further information can be found in the \href{https://github.com/pschatzmann/arduino-simple-tts/wiki}{\texttt{ Wiki}} and in my \href{https://www.pschatzmann.ch/home/tag/tts/}{\texttt{ Blogs}} 